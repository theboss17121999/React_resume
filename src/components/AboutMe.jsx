        ...
        <div className="px-4 md:px-0">
            <div>
                ...
                <div className="pt-16 flex justify-center md:justify-start">
                    <Link to="#Project" className="bg-purple-500 text-white font-bold py-4 px-16 rounded-lg text-xl transition ease-in-out delay-150 bg-blue-500 hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 duration-300" smooth>
                        PROJECT
                    </Link>
                </div>
            </div>
